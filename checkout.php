...
<body>
    ...
    <div class="container">
        ...
        <h1>Checkout
            ...
            <a style="color: #fff;" href="cart.php">
                <button class="btn btn-info pull-right">Cart</button>
            </a>
        ...
        <div class="container">
                ...
                while ( $row = $result->fetch( PDO::FETCH_ASSOC ) ) 
...

                    {
                        ...
                        echo "<br />";
                        echo "<p>Subtotal: $"; 
                        echo $subtotal = $cart * $price;
                        $total = $subtotal;
                        echo "</p>";
                        echo "<p>Tax: $";
                        echo $tax = intval($subtotal) * $taxRate;
                        $total += $tax;
                        echo "</p>";
                        echo "<p>Grandtotal: $"; 
                        echo $grandtotal = floatval($subtotal) + floatval($tax);
                        echo "</p>";
                        $total = $grandtotal;
                        echo "</div>";
